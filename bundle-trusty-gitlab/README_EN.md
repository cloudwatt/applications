...
* GitLab (gitlab-ce) 7.14.0-ce.0
* OpenSSH-Server (openssh-server) 1:6.6p1-2ubuntu2.3
* Python HTTP-client library (python-httplib2) 0.8-2build1
* Common CA certificates (ca-certificates) 20141019ubuntu0.14.04.1
* HTTPS download transport for APT (apt-transport-https) 1.0.1ubuntu2.10
* Postfix (postfix) 2.11.0-1ubuntu1
