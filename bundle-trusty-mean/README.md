...
* **M**ongoDB : Le désormais célèbre moteur NoSQL orienté document
* **E**xpress.js : Le framework web pour Node.js
* **A**ngular.js : Framework d'applications Front-web
* **N**ode.js : Le serveur d'application en Javascript
...
Les pré-requis pour déployer cette stack sont les mêmes que pour les épisodes précédents :
