...
Drupal Commons est un RSE, un Réseau Social d'Entreprise, permettant de mettre en relation les salariés d'une entreprise au sein de communautés.

Grâce à la communauté de contributeurs, de multiples modules sont disponibles afin d'ajouter de l'intéractivité entre les utilisateurs.

Son interface est intuitive et permet à tous de l'utiliser sans difficultés.

Drupal Commons est développé entièrement en PHP et utilise une base de données de type MySQL pour sauvegarder les informations diverses.
...
Une fois le dépôt cloné, vous trouverez le répertoire `blueprint-coreos-drupalcommons/`

* `blueprint-coreos-drupalcommons.heat.yml`: Template d'orchestration HEAT, qui servira à déployer l'infrastructure nécessaire.
...
parameters:
  ...
  sqlpass:
    description: "password sql (user: drupalcommons)"
    type: string
    hidden: true
...
~~~ bash
 ...
 +--------------------------------------+----------------+--------------------+----------------------+
 | ed4ac18a-4415-467e-928c-1bef193e4f38 | DrupalCommons  | CREATE_IN_PROGRESS | 2015-04-21T08:29:45Z |
 +--------------------------------------+----------------+--------------------+----------------------+
~~~
...
Enfin, attendez **5 minutes** que le déploiement soit complet.
 ...
 ~~~
   ...
   * démarrer une instance basée sur Coreos y déposer le conteneur *Drupal Commons* et le conteneur *MySQL*,
...
Et bien si ! En utilisant la console, vous pouvez déployer Drupal Commons :

1.	Allez sur le Github Cloudwatt dans le répertoire [applications/blueprint-coreos-drupalcommons](https://github.com/cloudwatt/applications/tree/master/blueprint-coreos-drupalcommons)
2.	Cliquez sur le fichier nommé `blueprint-coreos-drupalcommons.heat.yml`
...
Bon... en fait oui ! Allez sur la page [Applications](https://www.cloudwatt.com/fr/applications/) du site de Cloudwatt, choisissez l'appli, appuyez sur DEPLOYER et laisser vous guider... 2 minutes plus tard un bouton vert apparait... ACCEDER : vous avez accès à votre Réseau Social d'Entreprise !
...
Vous êtes maintenant en possession de Drupal Commons. Vous pouvez y acceder via l'url `http://ip-floatingip`. Votre url complète sera présente dans la vue d'ensemble de votre stack sur la console horizon Cloudwatt.
