...
it's able to generating a coded backup and to copy them where you want, duplicity is able to making back up full and incremental.
...
~~~
Start fully backup and copy in a remote server with keypair & passphrase & encrypt-key:
~~~
...
Start the restore command without Encryption:
~~~
