...
* for Ansible can install properly the playbooks, it is necessary that the **cloud** user is present on the machine. FYI, it is present on all the images provided by Cloudwatt.
## Removing the stack
